			...
			case "produit": case "produits" : case "prod":
				...
				switch(choice) {
					...
					case "supprimer un produit": case "supprimer" : case "suppr":
						System.out.println("ID du produit Ã  supprimer : ");
					...
					case "modifier un produit": case "modifier" : case "modif":
						...
						if(sc.nextLine().equals("o"))
						{
							...
							System.out.println(String.format("RÃ©cap : nom %s tarif %s", prodModif.getNom(), prodModif.getTarif()));
						}
						break;
					}
				break;
			...
			case "client": case "clients": case "les clients":
				...
				switch(choice) {
					...
					case "supprimer un client": case "supprimer" : case "suppr":
						System.out.println("ID du client Ã  supprimer : ");
						int supN = sc.nextInt();
						sc.nextLine();
			...
			case "categorie": case "categories": case "cat":
				...
				switch(choice) {
					...
					case "supprimer une categorie": case "supprimer" : case "suppr":
						System.out.println("ID de la categorie Ã  supprimer : ");
					...
					case "modifier une categorie": case "modifier" : case "modif":
						...
						if(sc.nextLine().equals("o"))
						{
							...
							System.out.println(String.format("RÃ©cap : titre %s visuel %s", cateModif.getTitre(), cateModif.getVisuel()));
						}
						break;
				}
				break;
