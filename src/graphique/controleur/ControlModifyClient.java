...
public class ControlModifyClient implements Initializable {
    ...
    public void ModifCli(MouseEvent mouseEvent) {

        Client client = ControlClients.getClient();
        String erreur = "";

        this.textFieldNom.setAccessibleText(client.getNom());
        this.textFieldPrenom.setAccessibleText(client.getPrenom());
        this.textFieldIdentifiant.setAccessibleText(client.getIdentifiant());
        this.textFieldMdp.setAccessibleText(client.getMdp());
        this.textFieldNum.setAccessibleText(client.getNum());
        this.textFieldVoie.setAccessibleText(client.getVoie());
        this.textFieldCP.setAccessibleText(client.getCp());
        this.textFieldVille.setAccessibleText(client.getVille());
        this.textFieldPays.setAccessibleText(client.getPays());
